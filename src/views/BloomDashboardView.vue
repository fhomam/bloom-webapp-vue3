  ...
  <div class="px-6 pb-6 pt-2 lg:px-8 lg:pb-8 lg:pt-4 max-w-[1600px] mx-auto w-full flex flex-col gap-4">
    ...
    <div class="flex items-center justify-between h-8 px-1">
      ...
      <div class="flex items-center gap-3">
        <button 
          @click="copyShareLink" 
          class="flex items-center justify-center gap-1.5 text-xs font-semibold w-20 transition-colors"
          :class="isCopied ? 'text-emerald-600' : 'text-slate-500 hover:text-bloom-primary'"
        >
          ...
          <svg v-else class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
